...
class PosixTzJulianDateTime:
    def __init__(self, day_of_year: int, hour: int, minute: int, second: int):
...
class PosixTzOrdinalDateTime:
    def __init__(self, day_index: int, hour: int, minute: int, second: int):
...
class PosixTzInfo:
    ...
    @classmethod
    def read(cls, file) -> "PosixTzInfo | None":
